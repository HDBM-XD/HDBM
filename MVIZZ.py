https://github.com/HDBM-XD/HDBM.git#!/usr/bin/env python
...
def buat_data(akun):
	...
	for sandi in pwx:
		if len(sandi) < 5 or sandi in tampung or len(''.join(filter(lambda x: not x.isdigit(), sandi))) < 5 : continue
